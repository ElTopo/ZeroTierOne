...
install:	FORCE
	...
	ln -sf $(DESTDIR)/var/lib/zerotier-one /var/lib/zerotier-one
	rm -f /var/lib/zerotier-one/zerotier-one
	rm -f /var/lib/zerotier-one/zerotier-cli
	rm -f /var/lib/zerotier-one/zerotier-idtool
	ln -s $(DESTDIR)/sbin/zerotier-one /var/lib/zerotier-one/zerotier-one
	ln -s $(DESTDIR)/sbin/zerotier-one /var/lib/zerotier-one/zerotier-cli
	ln -s $(DESTDIR)/sbin/zerotier-one /var/lib/zerotier-one/zerotier-idtool
